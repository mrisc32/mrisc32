...
\todo{Come up with a better name than "chunk"?}
...
The following notation is use in the pseudocode that describes the operation
of an instruction:
...
$<<$ & Bit shift left \\
$>>$ & Bit shift right (preserve sign bit for signed integer types) \\
