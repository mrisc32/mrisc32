...
It is a RISC style load-store vector architecture that is designed to be
suitable for a wide range of performance levels.
...
\begin{bytefield}{32}
  \bitheader{0,2,7,9,14,15,16,21,26,31} \\
...
the packed data type that is to be used (see
section~\ref{sec:packed_data_operation}). For load/store instructions it
