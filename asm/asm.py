...
_OPCODES = {
        ...
        'FCNE':   [[0x00000095, _REG1, _REG2, _REG3],
                   [0x80000095, _VREG1, _VREG2, _REG3],
                   [0xc0000095, _VREG1, _VREG2, _VREG3]],
        'FCLT':   [[0x00000096, _REG1, _REG2, _REG3],
                   [0x80000096, _VREG1, _VREG2, _REG3],
                   [0xc0000096, _VREG1, _VREG2, _VREG3]],
        'FCLE':   [[0x00000097, _REG1, _REG2, _REG3],
                   [0x80000097, _VREG1, _VREG2, _REG3],
                   [0xc0000097, _VREG1, _VREG2, _VREG3]],
        'FCNAN':  [[0x00000098, _REG1, _REG2, _REG3],
                   [0x80000098, _VREG1, _VREG2, _REG3],
                   [0xc0000098, _VREG1, _VREG2, _VREG3]],
        'FMIN':   [[0x00000099, _REG1, _REG2, _REG3],
                   [0x80000099, _VREG1, _VREG2, _REG3],
                   [0xc0000099, _VREG1, _VREG2, _VREG3]],
        'FMAX':   [[0x0000009a, _REG1, _REG2, _REG3],
                   [0x8000009a, _VREG1, _VREG2, _REG3],
                   [0xc000009a, _VREG1, _VREG2, _VREG3]],
